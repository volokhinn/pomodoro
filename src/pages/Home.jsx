            ...
            {stateTimer === "unActive" ? (
              ...
              >
                ...
                <div className={styles.buttons}>
                  {settingsActive ? (
                    ...
                    >
                      Начать{" "}
                      <img className={styles.btn__icon} src={play} alt={play} />
                    </LongButton>
                  ) : (
                ...
                <p className={styles.description}>
                  Чтобы начать сессию {Math.floor(defaultTime / 60)} минут
                  минут, жми <span style={{ color: "#fff" }}>Начать</span>
                </p>
              </motion.div>
            ) : stateTimer === "active" ? (
              <motion.div
              ...
              >
                ...
                <div className={styles.buttons}>
                  <LongButton onClick={() => onClickTimer()}>
                    Стоп{" "}
                    <img className={styles.btn__icon} src={stop} alt={stop} />
                  </LongButton>
                </div>

                <p className={styles.description}>
                  Жми <span style={{ color: "#fff" }}>Стоп</span> если решил
                  закончить раньше
                </p>
              </motion.div>
            ) : (
